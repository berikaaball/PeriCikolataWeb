...
<?php else : ?>
	...
	<?php wc_print_notice( esc_html__( 'Henuz siparis verilmedi.', 'woocommerce' ) . ' <a class="woocommerce-Button wc-forward button' . esc_attr( $wp_button_class ) . '" href="' . esc_url( apply_filters( 'woocommerce_return_to_shop_redirect', wc_get_page_permalink( 'shop' ) ) ) . '">' . esc_html__( 'Urunleri ara', 'woocommerce' ) . '</a>', 'dikkat' ); // phpcs:ignore WooCommerce.Commenting.CommentHooks.MissingHookComment ?>
