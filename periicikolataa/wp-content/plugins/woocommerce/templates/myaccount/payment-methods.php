...
<?php else : ?>
	...
	<?php wc_print_notice( esc_html__( 'Kayitli yontem bulunamadi.', 'woocommerce' ), 'dikkat' ); ?>
...
<?php if ( WC()->payment_gateways->get_available_payment_gateways() ) : ?>
	<a class="button" href="<?php echo esc_url( wc_get_endpoint_url( 'add-payment-method' ) ); ?>"><?php esc_html_e( 'Odeme yontemi', 'woocommerce' ); ?></a>
<?php endif; ?>
